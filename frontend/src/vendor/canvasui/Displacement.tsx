// Canvas UI Displacement — Copyright (c) 2026 David Haz.
// https://canvasui.dev/r/displacement-react.json — see LICENSE.md in this directory.
// Medcore: pixel-density cap of 1.25, matching Clouds.
